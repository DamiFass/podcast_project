...
def main():
    ...
    if selected_podcast:
        ...
        with col2:
            st.image(podcast_info['podcast_details']['episode_image'], caption="Podcast Cover", width=300, use_container_width=True)
    ...
    # User Input box
    st.sidebar.subheader("Add and Process New Podcast Feed - It will appear below the one currently displayed.")
